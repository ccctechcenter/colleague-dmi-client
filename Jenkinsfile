                ...
                script {
                    ...
                    if (env.BRANCH_NAME == "develop" && artifact_version =~ /SNAPSHOT/) { //publish a snapshot version if we're on develop branch
                        ...
                        nexusArtifactUploader artifacts: [
                                ...
                                [artifactId: 'colleague-dmi-client', classifier: '', file: "target/colleague-dmi-client-${artifact_version}-javadoc.jar", type: 'jar'],
                                [artifactId: 'colleague-dmi-client', classifier: '', file: "target/colleague-dmi-client-${artifact_version}-sources.jar", type: 'jar']
